# script to make ops file (run in suite2p conda environment)
import numpy as np
import suite2p
save_path = '/home/adamranson/data/configs/s2p_configs/ch_1_depth_1.npy'
...
ops = {
    ...
    'fs': 30.,  # sampling rate (PER PLANE e.g. for 12 plane recordings it will be around 2.5)
    ...
    'do_bidiphase': True, #whether or not to compute bidirectional phase offset (applies to 2P recordings only)
    'bidiphase': 0, # Bidirectional Phase offset from line scanning (set by user). Applied to all frames in recording.
    'bidi_corrected': True, # Whether to do bidirectional correction during registration
